...
namespace AweEditor
{
    ...
    class ContentBuilder : IDisposable
    {
        ...
        static string[] pipelineAssemblies =
        {
            ...
            Path.GetFullPath(Path.Combine(Assembly.GetExecutingAssembly().Location, "../../../../Content/")) + "VoxelTerrianMeshPipeline.dll",
        ...
        void CreateTempDirectory()
        {
            ...
            //
            //  %temp%\AweEditor.ContentBuilder\<ProcessId>
            ...
            //
            //  %temp%\AweEditor.ContentBuilder\<ProcessId>\<Salt>
